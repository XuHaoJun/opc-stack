...
# valkey.sh -> VALKEY_URL, rabbitmq.sh -> AMQP_URL,
# http.sh -> DEV_PORT, DEV_PORT_<n>, DEV_URL, DEV_HOST, HOST,
# s3.sh -> AWS_ENDPOINT_URL, AWS_ACCESS_KEY_ID,
...
# Derived by reading providers/*.sh: postgres.sh, valkey.sh, rabbitmq.sh,
# http.sh, s3.sh.
